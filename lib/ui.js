...
function deleteLineFromCart(event) {
  ...
  //console.log("fjöldi barna er ", lineToDelete.parentElement.childElementCount === 1);
  if(lineToDelete.parentElement.childElementCount === 1){
...
export function createCartLine(product, quantity) {
  ...
  */
  ...
  totalElement.classList.add('samtals')
